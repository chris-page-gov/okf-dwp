...
status. That increment has 29 support dependencies, with two captured pages newly selected
...
remain open. The qualification source has since passed protected publication
and a [separate public Chrome check](../validation/household-reader-public/7f9feb96-c4f2de0a/README.md).
Later source increments need their own publication observations.
