...
Priority **P0**; aggregate status `not_started`.

| Work package | Kind | Status | Executor | Next action or retained result |
| --- | --- | --- | --- | --- |
| `DWP-BL-016.delivery` | implementation | `not_started` | agent | Prepare explicit Voice capability checks and a text/recorded fallback. |
...
Evidence: [docs/next-stage/seminar-webmcp-and-audio.md](../docs/next-stage/seminar-webmcp-and-audio.md) · [docs/remote-mcp-demo.md](../docs/remote-mcp-demo.md)
...
Evidence: [validation/corpus-questions/public-explorer-observation.json](../validation/corpus-questions/public-explorer-observation.json) · [docs/combined-reader.md](../docs/combined-reader.md) · [validation/combined-reader/README.md](../validation/combined-reader/README.md) · [validation/combined-reader/browser/artifacts.json](../validation/combined-reader/browser/artifacts.json) · [validation/combined-reader/build.json](../validation/combined-reader/build.json) · [validation/combined-reader/public/README.md](../validation/combined-reader/public/README.md) · [validation/combined-reader/public/artifacts.json](../validation/combined-reader/public/artifacts.json)
