...
| Graph and consumer quality | Source hashes, exact evidence, independent research review and existing retrieval receipts | Final immutable candidate checks, full-corpus load/search/graph measurements and observed browser routes. Preserve the documented targeted-resource-hydration limitation. |
