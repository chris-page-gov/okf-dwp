...
| Direct paired model trial | Both v4 empty controls and both Staff 012 answers were accepted by the mechanical checks, with zero observed tool calls. Independent claim review is pending; this is not a legal-accuracy result. | [Paired v4 attempts and limits](../validation/model-comparison/household-direct-v4/README.md) |
