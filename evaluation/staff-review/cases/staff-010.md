# staff-010: What is used in the Pension Credit calculation to assess eligibility and what is the threshold for each element?
...
- Complete inputs, exclusions, disregards, calculation dependencies and versioned thresholds for the agreed scope.
- Eligibility, award calculation and numeric thresholds are distinct.
- Date, Guarantee Credit/Savings Credit, household and relevant benefit regimes are unspecified.
...
### source-c013: DMG Vol 13 Ch 77: Conditions of entitlement, membership of the household and normal amount payable — PDF page 35

[Official source](https://assets.publishing.service.gov.uk/media/68401a731d85c6606009cce4/dmgch77.pdf#page=35) · [Exact excerpt and hashes](../evidence/source-c013.json)
...
Excerpt omits 344 characters before and 0 after on this page. Check surrounding text and adjacent pages.
...
The retained run selected 61 records, using 470,542 bytes. It retained 0 of 5 independently located candidate pages. This measures candidate overlap, not substantive correctness.
