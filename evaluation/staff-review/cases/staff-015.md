# staff-015: What inputs are required for the Pension Credit calculation?
...
- A complete source-backed input inventory including exclusions and evidence needed to determine each field.
- The intended calculation date, household, credit component and scope are unspecified.
...
The retained run selected 60 records, using 471,713 bytes. It retained 0 of 5 independently located candidate pages. This measures candidate overlap, not substantive correctness.
