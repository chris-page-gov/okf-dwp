...
try {
  ...
  let multiPageUnits = 0, spanCount = 0, sourceTextBytes = 0, discoveryBytes = 0, firstCard;
  function* cardRows() {
  ...
  report.checks.push({ gate: phase, evidence_records: ordinal, discovery_cards: cardIds.size, multi_page_units: multiPageUnits,
    source_spans: spanCount, source_text_bytes: sourceTextBytes, card_bytes: discoveryBytes, total_tokens: totals });
  ...
  report.runner_sha256 = sha(readFileSync(fileURLToPath(import.meta.url)));
