# Source-led context comparison

This is an independent experimental publication. Navigation, evidence delivery and legal answerability are separate.

The report covers **40 unchanged staff question occurrences** in each stage and budget, plus a separate unknown-question control.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| logical-context | 32768 | 6 | 8 | 0 | 40 | 40 | 40 |
| logical-context | 524288 | 40 | 8 | 18 | 40 | 40 | 40 |
| structured-context | 32768 | 0 | 40 | 0 | 40 | 40 | 40 |
| structured-context | 524288 | 40 | 40 | 40 | 40 | 40 | 40 |

## Reading the measures

- This summarises retained assemblies; it does not execute retrieval or a model.
