...
const indexRaw=await read('evaluation/semantic-expansion/assembly-index.json');
...
const inputs={protocol_sha256:sha(protocolRaw),registry_sha256:sha(registryRaw),semantic_index_sha256:sha(indexRaw),
 original_corpus_manifest_sha256:sha(originalRaw),exporter_sha256:sha(await readFile(fileURLToPath(import.meta.url))),engine:{}};
