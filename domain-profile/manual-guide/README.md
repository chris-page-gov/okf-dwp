...
Twenty conventions cite 30 exact excerpts from 15 documents. They cover document roles, chapter and benefit scope, local definitions, numbering, mixed contents and body text, cross-page conditions, examples, notes, citations, abbreviations, statutes, statutory instruments, memos and update histories. **These are scoped examples, not a reviewed grammar for all 513 documents.**
